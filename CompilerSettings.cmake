...
EnableOption(VKE_RENDER_SYSTEM_VULKAN)
EnableOption(VKE_RENDER_SYSTEM_D3D12)
...
if(VULKAN_RENDER_SYSTEM_ENABLED)
	set(PREPROCESSOR_DEFINITIONS ${PREPROCESSOR_DEFINITIONS} VKE_RENDER_SYSTEM_VULKAN)
endif()

if(D3D12_RENDER_SYSTEM_ENABLED)
	set(PREPROCESSOR_DEFINITIONS ${PREPROCESSOR_DEFINITIONS} VKE_RENDER_SYSTEM_D3D12)
endif()
