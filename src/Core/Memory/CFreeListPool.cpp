...
namespace VKE
{
    namespace Memory
    {
        const CFreeListPool::SHandle CFreeListPool::INVALID_HANDLE = { CFreeListPool::MAX_POOL_COUNT,
                                                                       CFreeListPool::MAX_ALLOC_COUNT };
        ...
        Result CFreeListPool::Create( uint32_t freeListElementCount, size_t freeListElemenetSize,
