...
#if defined( VKE_COMPILER_MINGW ) || defined( __MINGW32__ )
// Associate DXC interface UUIDs with their types so __uuidof<T>() links under MinGW.
// GUIDs come from dxcapi.h (CROSS_PLATFORM_UUIDOF entries).
...
// ...add any other IDxc* interfaces you pass to __uuidof / CreateInstance
#endif
