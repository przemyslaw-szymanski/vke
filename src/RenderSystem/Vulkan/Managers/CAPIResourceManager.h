...
//            using ImageDescArray = Utils::TCDynamicArray< STextureDesc, DEFAULT_RESOURCE_COUNT >;
//            using ImageViewDescArray = Utils::TCDynamicArray< STextureViewDesc, DEFAULT_RESOURCE_COUNT >;
...
//                const STextureDesc& GetTextureDesc(const TextureHandle& hTex) const { return m_vImageDescs[static_cast<uint32_t>(hTex.handle)]; }
//                const STextureDesc& GetTextureDesc(const TextureViewHandle& hView) const;
...
//                const STextureViewDesc& GetTextureViewDesc(const TextureViewHandle& hView) const { return m_vImageViewDescs[ static_cast<uint32_t>(hView.handle) ].Info; }
