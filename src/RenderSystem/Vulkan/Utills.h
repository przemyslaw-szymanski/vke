...
namespace VKE::RenderSystem::Vulkan
{
    ...
    template<typename _INFO_, typename _TYPE_> vke_force_inline void InitInfo( _INFO_* pInfo, _TYPE_ type )
    {
        Memory::Zero( pInfo, 1 );
        pInfo->sType = type;
    }
    template<typename VkObj, typename VkCreateInfo> struct TSVkObject
    {
        VkObj handle;
    ...
    using QueueFamilyPropertyArray = Utils::TCDynamicArray<VkQueueFamilyProperties, 1>;
    //using QueueFamilyInfoArray     = Utils::TCDynamicArray<VKE::RenderSystem::SQueueFamilyInfo>;
    ...
    struct SDeviceProperties
    {
        ...
        struct
        {
            ...
            VkFormatProperties                              aFormatProperties[ VKE::RenderSystem::Formats::_MAX_COUNT ];
        } Properties;
        ...
        void                    operator=( const SDeviceProperties& Rhs )
        {
            ...
            Memory::Copy<VKE::RenderSystem::Formats::_MAX_COUNT>( Properties.aFormatProperties,
                                                                  Rhs.Properties.aFormatProperties );
                            ...
                            VkSemaphore vkWaitSemaphore )
    {
        ...
        if( this->GetRefCount() == m_PresentData.vSwapChains.GetCount() )
        {
            ...
            // $TID Present: q={vkQueue}, sc={m_PresentInfo.pSwapchains[0]}, imgIdx={m_PresentInfo.pImageIndices[0]},
            // ws={m_PresentInfo.pWaitSemaphores[0]}
    ...
    bool IsColorImage( VkFormat format )
    {
        switch( format )
        {
            ...
            case VK_FORMAT_S8_UINT: return false;
        }
        return true;
    }
    ...
    namespace Map
    {
        ...
        {
            static const VkImageLayout aVkLayouts[] = { VK_IMAGE_LAYOUT_UNDEFINED,
        ...
        {
            static const VkPrimitiveTopology aVkTopologies[] = { VK_PRIMITIVE_TOPOLOGY_POINT_LIST,
        ...
        {
            static const VkFrontFace aVkFaces[] = { VK_FRONT_FACE_COUNTER_CLOCKWISE, VK_FRONT_FACE_CLOCKWISE };
        ...
        {
            static const VkShaderStageFlagBits aVkBits[] = { VK_SHADER_STAGE_VERTEX_BIT,
        ...
        {
            static const VkVertexInputRate aVkRates[] = { VK_VERTEX_INPUT_RATE_VERTEX, VK_VERTEX_INPUT_RATE_INSTANCE };
...
#undef VKE_ICD_GLOBAL
        ...
        pOut->vkGetInstanceProcAddr
            = reinterpret_cast<PFN_vkGetInstanceProcAddr>( Platform::GetProcAddress( hLib, "vkGetInstanceProcAddr" ) );
        ...
        pOut->vkEnumerateInstanceExtensionProperties = reinterpret_cast<PFN_vkEnumerateInstanceExtensionProperties>(
