...
namespace VKE
{
    namespace RenderSystem
    {
            ...
            using QueueFamilyPropertyArray
                = Utils::TCDynamicArray<SQueueFamilyProperties, DEFAULT_QUEUE_FAMILY_PROPERTY_COUNT>;
            ...
            class VKE_API CDDI
            {
              ...
              public:
                ...
                // void            BeginRenderPass( const NativeAPI::CommandBuffer& hCommandBuffer, const SBeginRenderPassInfo&
                // Info ); void            EndRenderPass( const NativeAPI::CommandBuffer& hCommandBuffer );
