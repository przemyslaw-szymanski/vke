...
//    }
//
//    Result GetInstanceValidationLayers(VkICD::Global &Global, DDIExtMap *pmLayersInOut, DDIExtArray *pvRequiredInOut,
//                                       CStrVec *pvNames)
//    {
...
//    };
//
//    Result QueryAdapterProperties(const NativeAPI::Adapter &hAdapter, const DDIExtMap &mExts, SDeviceProperties *pOut)
//    {
...
//            NextProperties.Add(&Properties.MeshShaderNV, VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV);
//            NextFeatures.Add(&Features.MeshShaderEXT, VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_EXT);
//            NextProperties.Add(&Properties.MeshShaderEXT, VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_EXT);
//        }
...
//            sInstanceICD.vkGetPhysicalDeviceFormatProperties(hAdapter, fmt, &pOut->Properties.aFormatProperties[i]);
//        }
//        return VKE_OK;
//    }
//
...
//        VK_ERR(InstanceICD.vkEnumerateDeviceExtensionProperties(vkPhysicalDevice, nullptr, &count, &vProperties[0]));
//        std::string ext;
//        vke_string  tmpName;
//        tmpName.reserve(128);
...
//                                {
//                                    vkRes = sInstanceICD.vkCreateDebugUtilsMessengerEXT(sVkInstance, &DbgUtils, nullptr,
...
//        Alignment.bufferCopyOffset = static_cast<uint32_t>(m_DeviceProperties.Limits.optimalBufferCopyOffsetAlignment);
...
//        Memory.minConstantBufferOffsetAlignment = (uint32_t)m_DeviceProperties.Limits.minUniformBufferOffsetAlignment;
//        Memory.minStorageBufferOffsetAlignment  = (uint32_t)m_DeviceProperties.Limits.minStorageBufferOffsetAlignment;
...
//                                                              .pNext = nullptr };
//        auto                             nativeResult =
//            sInstanceICD.vkGetPhysicalDeviceImageFormatProperties2(m_hAdapter, &NativeFormatInfo, &NativeProperties);
//        VK_ERR(nativeResult);
...
//                               Params.Indexed.startIndex, Params.Indexed.vertexOffset, Params.Indexed.startInstance);
//    }
//
...
//        m_ICD.vkCmdCopyBufferToImage(hCmdBuffer, Info.hDDISrcBuffer, Info.hDDIDstTexture, vkLayout, vRegions.GetCount(),
//                                     &vRegions[0]);
//    }
//
...
//    }
//
//    void TextureSubresourceToNativeSubresource(const STextureSubresourceRange &Subres, VkImageSubresourceLayers *pOut)
//    {
...
//        m_ICD.vkCmdCopyImage(hDDICmdBuffer, Info.pBaseInfo->hDDISrcTexture, vkSrcLayout, Info.pBaseInfo->hDDIDstTexture,
...
//    }
//
//    Result ConvertVkSurfaceFormatToPresentSurfaceFormat(const VkSurfaceFormatKHR &vkFormat, SPresentSurfaceFormat *pOut)
//    {
//        Result ret = VKE_OK;
...
//            res = sInstanceICD.vkGetPhysicalDeviceSurfacePresentModesKHR(m_hAdapter, hSurface, &presentCount, nullptr);
//            VK_ERR(res);
//            if (res == VK_SUCCESS)
//            {
//                if (presentCount > 0)
...
//    }
//
//    VKAPI_ATTR VkBool32 VKAPI_CALL VkDebugCallback(VkDebugReportFlagsEXT msgFlags, VkDebugReportObjectTypeEXT objType,
...
//    }
//
//    VKAPI_ATTR VkBool32 VKAPI_CALL VkDebugMessengerCallback(VkDebugUtilsMessageSeverityFlagBitsEXT      messageSeverity,
...
//            }
//        }
//        VKE_ASSERT2(messageSeverity != VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT, pCallbackData->pMessageIdName);
//#endif
//        return VK_FALSE;
//    }
} // namespace VKE::RenderSystem
