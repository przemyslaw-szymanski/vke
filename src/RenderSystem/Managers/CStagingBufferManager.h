...
#define VKE_CHUNKED_STAGING_BUFFER 1
        ...
        class CStagingBufferManager
        {
            ...
            using PageBatchType = uint16_t; // for performance pages are stored in batches of 16 -
                                            // 1 bit for a page
        ...
        public:
            ...
            // SBufferData** ppData );
            Result GetBuffer( const SBufferRequirementInfo& Info, StagingBufferFlags Flags, handle_t* phBufferInOut,
