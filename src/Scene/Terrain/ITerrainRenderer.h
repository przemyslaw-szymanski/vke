...
namespace VKE
{
    ...
    namespace Scene
    {
        ...
        public:
            ...
            virtual Result UpdateBindings( RenderSystem::CommandBufferPtr, STerrainUpdateBindingData& )
            {
                return VKE_OK;
            }
        ...
        protected:
            virtual Result _Create( const STerrainDesc& Desc, RenderSystem::CommandBufferPtr )
            {
                return VKE_OK;
            }
            ...
            virtual RenderSystem::PipelinePtr _GetPipelineForLOD( uint8_t )
            {
                return {};
            }
        };
