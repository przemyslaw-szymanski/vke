...
if(VKE_DEBUG_INFO)
    AddReleaseLinkerSettings("/DDEBUG")
endif()
...
function(SetProjectLinkProperties ver)
    ...
    set_target_properties(${PROJECT_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_${ver} ${OUTPUT_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES EXECUTABLE_OUTPUT_DIRECTORY_${ver} ${OUTPUT_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES ARCHIVE_OUTPUT_DIRECTORY_${ver} ${LIB_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES LIBRARY_OUTPUT_DIRECTORY_${ver} ${LIB_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES IMPORT_LIBRARY_OUTPUT_DIRECTORY_${ver} ${LIB_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES RUNTIME_OUTPUT_DIRECTORY_${ver} ${OUTPUT_DIR})
    set_target_properties(${PROJECT_NAME} PROPERTIES EXECUTABLE_OUTPUT_DIRECTORY_${ver} ${OUTPUT_DIR})
#set_target_properties(${PROJECT_NAME} PROPERTIES LINK_FLAGS_${ver} ${RELEASE_LINKER_SETTINGS})
endfunction()

function(SetProjectLinkAllProperties)
    get_property(configList GLOBAL PROPERTY VKE_CONFIGURATION_LIST)
    #message(STATUS "config list: ${configList}")
    foreach(cfg in ${configList})
        SetProjectLinkProperties( ${cfg} )
    endforeach()
endfunction()
