...
if(VCPKG_TARGET_IS_MINGW)
  # MinGW defines NTDDI_WIN11_GE but its dxgiformat.h lacks the Windows 11 SDK
  # enumerator DXGI_FORMAT_A4B4G4R4_UNORM (191). DirectXTex uses its own
  # WIN11_DXGI_FORMAT_A4B4G4R4_UNORM define everywhere; only this static_assert
  # (which merely validates the SDK value) fails to compile. Remove it.
  vcpkg_replace_string(
      "${SOURCE_PATH}/DirectXTex/DirectXTexUtil.cpp"
      "static_assert(WIN11_DXGI_FORMAT_A4B4G4R4_UNORM == DXGI_FORMAT_A4B4G4R4_UNORM, \"Windows SDK mismatch detected\");"
      "// static_assert removed by overlay port: DXGI_FORMAT_A4B4G4R4_UNORM missing from MinGW SDK"
  )
endif()
