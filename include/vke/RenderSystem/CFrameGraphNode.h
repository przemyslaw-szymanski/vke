...
namespace VKE::RenderSystem
{
    ...
    struct VKE_API SSynchronizationObject
    {
        union
        {
            NativeTypes::CPUFence GPUToCPU;
            NativeTypes::GPUFence GPUToGPU;
        ...
        SSynchronizationObject( const NativeTypes::CPUFence& Obj ) :
            GPUToCPU{ Obj }, type{ SynchronizationObjectTypes::GPU_TO_CPU }
        {
        }

        SSynchronizationObject( const NativeTypes::GPUFence& Obj ) :
    ...
    protected:
        ...
        using GPUFenceArray                           = Utils::TCDynamicArray< NativeTypes::GPUFence, 1 >;
        using CPUFencearray                           = Utils::TCDynamicArray< NativeTypes::CPUFence, 1 >;
    ...
    public:
        ...
        using CPUFenceTaskResultMap = vke_map< NativeTypes::CPUFence, TaskResultArray >;
    ...
    public:
        ...
        //NativeTypes::GPUFence&   GetGPUFence( uint32_t backBufferIndex ) const;
        //NativeTypes::CPUFence&   GetCPUFence( uint32_t backBufferIndex ) const;
        Platform::ThreadFence& GetThreadFence();

        void   SignalThreadFence( uint32_t value );
        void   IncrementThreadFence();
        Result Wait( const NativeTypes::GPUFence& );
        Result Wait( const NativeTypes::CPUFence&, uint64_t timeout );
    ...
    protected:
        ...
        NativeTypes::FenceValue   m_fenceValue = 0;
        ...
        NativeTypes::RenderPass   m_hNativeRenderPass = NativeTypes::Null;
    ...
    class VKE_API CFrameGraphExecuteNode final : public CFrameGraphNode
    {
        ...
        struct SExecuteData
        {
            Utils::TCDynamicArray< NativeTypes::CommandBuffer > vpCommandBuffers;
