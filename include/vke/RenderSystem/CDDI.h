...
namespace VKE
{
    namespace RenderSystem
    {
        ...
        // using QueueFamilyPropertyArray = Utils::TCDynamicArray< VkQueueFamilyProperties,
        // DEFAULT_QUEUE_FAMILY_PROPERTY_COUNT >;
        ...
        class VKE_API CDDI final
        {
          ...
          public:
            static const NativeAPI::GlobalAPI& GetGlobalICD()
            {
                return sGlobalICD;
            }
            static const NativeAPI::InstanceAPI& GetInstantceICD()
            {
                return sInstanceICD;
            }
            static NativeAPI::Instance GetInstance()
            {
                return sInstance;
            }
            Result                      CreateDevice( const SCreateDeviceDesc& Info, CDeviceContext* pCtx );
            void                        DestroyDevice();
            const NativeAPI::DeviceAPI& GetDeviceICD() const
            {
                return m_DeviceApi;
            }
            const NativeAPI::DeviceAPI& GetICD() const
            {
                return m_DeviceApi;
            }
            ...
            Result GetBufferMemoryRequirements( const NativeAPI::Buffer&          hBuffer,
            ...
            // void            BeginRenderPass( const NativeAPI::CommandBuffer& hCommandBuffer, const
            // SBeginRenderPassInfo& Info ); void            EndRenderPass( const NativeAPI::CommandBuffer&
            // hCommandBuffer );
          ...
          protected:
            static NativeAPI::GlobalAPI   sGlobalICD;
            static NativeAPI::InstanceAPI sInstanceICD;
            static handle_t               shICD;
            static NativeAPI::Instance    sInstance;
            static AdapterArray           svAdapters;
            static DDIExtArray            svExtensions;
            static DDIExtLayerArray       svLayers;
            NativeAPI::DeviceAPI          m_DeviceApi;
            SNativeApiInternalData*       m_pInternal = nullptr;
