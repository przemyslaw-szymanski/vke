...
namespace VKE
{
    namespace Vulkan
    {
        namespace Wrapper
        {
            ...
            {
            public:
                TCBase( DevICD ICD, VkHandle vkHandle ) : m_ICD( ICD ), m_vkHandle( vkHandle )
                {
                }
            ...
            {
            public:
                CCommandBuffer( DevICD ICD, VkCommandBuffer vkCb ) : TCBase( ICD, vkCb )
                {
                }
                ...
                Begin( VkCommandBufferUsageFlags vkCbUsageFlags = VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT )
                {
                ...
                PipelineBarrier( VkPipelineStageFlags srcStageMask, VkPipelineStageFlags dstStageMask,
                ...
                {
                    m_ICD.vkCmdPipelineBarrier( m_vkHandle,
                                                srcStageMask,
                                                dstStageMask,
                                                dependencyFlags,
                                                memoryBarrierCount,
