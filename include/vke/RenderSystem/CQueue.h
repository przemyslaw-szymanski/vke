...
namespace VKE
{
    namespace RenderSystem
    {
        ...
        public:
            ...
            int8_t GetContextRefCount() const
            {
                return m_contextRefCount;
            }
        ...
        protected:
            ...
            void _RemoveContextRef()
            {
                m_contextRefCount--;
                VKE_ASSERT2( m_contextRefCount >= 0, "Too many ref removes." );
            }
