...
#define VKE_RENDER_SYSTEM_DEFINE_TO_NATIVE( _type )                                                                                      \
    ...
    inline NativeAPIT::_type ToNative( RHI::_type hObj )                                                   \
    {                                                                                                                  \
...
VKE_RENDER_SYSTEM_DEFINE_TO_NATIVE( QueueFamilyProperties )
    ...
    std::is_base_of_v< RHI::TSHandle< typename RenderSystemNativeT::TagType, typename RenderSystemNativeT::HandleType >,
                       RenderSystemNativeT >;
