...
namespace VKE
{
    namespace RenderSystem
    {
        ...
        class CDescriptorSetManager
        {
            ...
            using DDISetArray = Utils::TCDynamicArray< NativeTypes::DescriptorSet,
                                                       Config::RenderSystem::Pipeline::MAX_DESCRIPTOR_SET_COUNT >;
            using DDISetPool  = Utils::TSFreePool< NativeTypes::DescriptorSet, SetHandle,
                                                   Config::RenderSystem::Pipeline::MAX_DESCRIPTOR_SET_COUNT >;
            ...
            struct SPool
            {
                ...
                SPool( NativeTypes::DescriptorPool hDDI ) : hDDIObject{ hDDI }
                {
                    SetPool.Add( {} );
                }

                NativeTypes::DescriptorPool hDDIObject;
                DDISetPool                SetPool;
            };

            using PoolDescArray  = Utils::TCDynamicArray< SDescriptorPoolDesc >;
            using DDIPoolBuffer  = Utils::TSFreePool< NativeTypes::DescriptorPool, uint16_t >;
        ...
        public:
            ...
            const NativeTypes::DescriptorSet& GetSet( const DescriptorSetHandle& hSet );
            DescriptorSetLayoutHandle       GetLayout( const DescriptorSetHandle& hSet );
            NativeTypes::DescriptorSetLayout  GetLayout( const DescriptorSetLayoutHandle& hLayout );
