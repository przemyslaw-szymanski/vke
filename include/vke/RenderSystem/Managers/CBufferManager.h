...
namespace VKE
{
    namespace RenderSystem
    {
        ...
        public:
            ...
            void*        LockMemory( const SUpdateMemoryInfo& );
            void         UnlockMemory( const SUpdateMemoryInfo& );
            ...
            CStagingBufferManager* GetStagingBufferManager() const
            {
                return m_pStagingBufferMgr;
            }
        ...
        protected:
            ...
            Result _GetStagingBuffer( const SUpdateMemoryInfo& Info, const CDeviceContext* pCtx, handle_t* phInOut,
                                      SStagingBufferInfo* pOut, CCommandBuffer** ppTransferCmdBufferOut );
