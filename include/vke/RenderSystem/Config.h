    ...
    namespace Config
    {
        namespace RenderSystem
        {
            ...
            struct Pipeline
            {
                ...
                static const uint32_t   MAX_PIPELINE_LAYOUT_COUNT =
                    4096; // Max num of pipeline layout that could be allocated
            ...
            struct Buffer
            {
                ...
                static const uint32_t MAX_BUFFER_COUNT = MAX_VERTEX_BUFFER_COUNT + MAX_VERTEX_BUFFER_VIEW_COUNT +
