    ...
    namespace Core
    {
        ...
        struct CreateResourceFlags
        {
            enum FLAG : uint8_t
            {
                ...
                DO_NOT_DESTROY_STAGING_RESOURCES =
                    VKE_BIT( 3 ), // if a temporary resource is created, do not destroy it
                _MAX_COUNT = 4
            };
        };
...
public:                                                                                                                \
    vke_force_inline ::VKE::Core::ResourceStateBits GetResourceState() const                                               \
    {                                                                                                                  \
...
protected:                                                                                                             \
    ...
    {                                                                                                                  \
        ...
        _RemoveResourceState( VKE::Core::ResourceStates::LOCKED );                                                     \
                                                                                                                       ...
                                                                                                                       \
protected:                                                                                                             \
    ::VKE::Core::ResourceStateBits m_resourceStates = 0;                                                                   \
                                                                                                                       \
protected:                                                                                                             \
    uint32_t m_resourceThreadIdLock = 0
        ...
        public:
            ...
            bool vke_force_inline IsReady() const
            {
                return m_resourceState & ResourceStates::PREPARED;
            }

            bool vke_force_inline IsInvalid() const
            {
                return m_resourceState & ResourceStates::INVALID;
            }

            bool vke_force_inline IsLoaded() const
            {
                return m_resourceState & ResourceStates::LOADED;
            }

            bool vke_force_inline IsUnLoaded() const
            {
                return m_resourceState & ResourceStates::UNLOADED;
            }

            bool vke_force_inline IsCreated() const
            {
                return m_resourceState & ResourceStates::CREATED;
            }
...
namespace VKE::Core
{
    ...
    protected:
        ...
        ResourceStateBits m_ResourceStates = ResourceStates::UNKNOWN;
    };
} // namespace VKE::Core