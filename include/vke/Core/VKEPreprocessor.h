...
#define VKE_DEBUG_TEXT                                                                                                 \
    ...
    cstr_t GetDebugText() const                                                                                        \
    {                                                                                                                  \
        return _DbgText.GetData();                                                                                     \
    }                                                                                                                  \
    bool IsDebugTextSet() const                                                                                        \
    {                                                                                                                  \
        return !_DbgText.IsEmpty();                                                                                    \
    }
#else
...
#define VKE_DEBUG_TEXT                                                                                                 \
    ...
    template< typename... ArgsT >                                                                                      \
    void SetDebugText( cstr_t, ArgsT&&... )                                                                            \
    {                                                                                                                  \
    }                                                                                                                  \
    cstr_t GetDebugText() const                                                                                        \
    {                                                                                                                  \
...
#define VKE_ASSERT2( _condition, ... )                                                                                 \
    VKE_ASSERT_DETAILS( _condition, VKE_ASSERT_ERROR, __FILE__, __FUNCTION__, __LINE__, __VA_ARGS__ )
#define VKE_ASSERT( _condition )                                                                                       \
    VKE_ASSERT_DETAILS( _condition, VKE_ASSERT_ERROR, __FILE__, __FUNCTION__, __LINE__, "" )
#define VKE_ASSERT_PERF( _condition, ... )                                                                             \
    VKE_ASSERT_DETAILS( _condition, VKE_ASSERT_PERFORMANCE, __FILE__, __FUNCTION__, __LINE__, __VA_ARGS__ )
#define VKE_ASSERT_WARN( _condition, ... )                                                                             \
    VKE_ASSERT_DETAILS( _condition, VKE_ASSERT_WARNING, __FILE__, __FUNCTION__, __LINE__, __VA_ARGS__ )
#else
#define VKE_ASSERT( _condition ) ( (void)( _condition ) )
