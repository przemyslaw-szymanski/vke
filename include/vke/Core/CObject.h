...
public:                                                                                                                \
    _type GetHandle() const                                                                                            \
    {                                                                                                                  \
        return m_hObject;                                                                                              \
    }                                                                                                                  \
                                                                                                                       \
protected:                                                                                                             \
    void vke_force_inline _SetHandle( const _type& handle )                                                            \
    {                                                                                                                  \
        m_hObject = handle;                                                                                            \
    }                                                                                                                  \
                                                                                                                       \
protected:                                                                                                             \
    _type m_hObject = INVALID_HANDLE

#define VKE_DECL_OBJECT_REF_COUNT( _startRefCount )                                                                    \
public:                                                                                                                \
    vke_force_inline uint32_t _AddRef()                                                                                \
    {                                                                                                                  \
        return ++m_objRefCount;                                                                                        \
    }                                                                                                                  \
                                                                                                                       \
public:                                                                                                                \
    vke_force_inline uint32_t _RemoveRef()                                                                             \
    {                                                                                                                  \
        VKE_ASSERT2( m_objRefCount > 0, "" );                                                                          \
        return --m_objRefCount;                                                                                        \
    }                                                                                                                  \
                                                                                                                       \
public:                                                                                                                \
    vke_force_inline uint32_t GetRefCount() const                                                                      \
    {                                                                                                                  \
        return m_objRefCount;                                                                                          \
    }                                                                                                                  \
                                                                                                                       \
protected:                                                                                                             \
    uint32_t m_objRefCount = ( _startRefCount )

#define VKE_DECL_OBJECT_TS_REF_COUNT( _startRefCount )                                                                 \
public:                                                                                                                \
    vke_force_inline uint32_t _AddRefTS()                                                                              \
    {                                                                                                                  \
        ...
        return _AddRef();                                                                                              \
                                                                                                                       ...
                                                                                                                       \
public:                                                                                                                \
    vke_force_inline uint32_t _RemoveRefTS()                                                                           \
    {                                                                                                                  \
        Threads::ScopedLock l( m_SyncObj );                                                                            \
        return _RemoveRef();                                                                                           \
    }                                                                                                                  \
                                                                                                                       \
public:                                                                                                                \
    vke_force_inline uint32_t GetRefCountTS()                                                                          \
    {                                                                                                                  \
        Threads::ScopedLock l( m_SyncObj );                                                                            \
        return GetRefCount();                                                                                          \
    }                                                                                                                  \
                                                                                                                       \
protected:                                                                                                             \
    vke_force_inline Threads::SyncObject& _GetSyncObject()                                                             \
    {                                                                                                                  \
        return m_SyncObj;                                                                                              \
    }                                                                                                                  \
...
#define VKE_DECL_BASE_OBJECT( _handleType )                                                                            \
    ...
    VKE_DECL_OBJECT_TS_REF_COUNT( 1 )
        ...
        public:
            ...
            vke_force_inline const Threads::SyncObject& _GetSyncObject() const
            {
                return m_SyncObj;
            }
...
public:                                                                                                                \
    ...
    vke_force_inline uint32_t _GetRefCount() const                                                                     \
    {                                                                                                                  \
        return m_objRefCount;                                                                                          \
    }                                                                                                                  \
                                                                                                                       \
