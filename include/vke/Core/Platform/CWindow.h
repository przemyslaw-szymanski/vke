...
namespace VKE
{
    ...
    public:
        ...
        RenderSystem::CSwapChain* GetSwapChain() const
        {
            return m_pSwapChain;
        }
        ...
        const Input::CInputSystem& GetInputSystem() const
        {
            return m_InputSystem;
        }

        Input::CInputSystem& GetInputSystem()
        {
            return m_InputSystem;
        }
        ...
        const ImageSize& GetClientSize() const
        {
            return m_ClientSize;
        }
