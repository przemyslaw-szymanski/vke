...
namespace VKE
{
    namespace Math
    {
        ...
        public:
            ...
            CMatrix4x4& operator=( CMatrix4x4&& Other )
            {
                _Native = Other._Native;
                return *this;
            }
            ...
            void vke_force_inline Translate( const CVector3& Vec )
            {
                Translate( Vec, this );
            }

            void vke_force_inline Scale( const CVector3& vecScale )
            {
                Scale( vecScale, this );
            }
            ...
            static void vke_force_inline Transform( const CVector4& vecDirection, const CMatrix4x4& mtxTransform,
                                                    CVector4* pOut );
            ...
            static vke_force_inline const CMatrix4x4& _Identity()
            {
                return IDENTITY;
            }
