...
namespace VKE
{
    namespace Math
    {
        void CFrustum::Update()
        {
            ...
            DirectX::XMVECTOR vRightBottom =
                DirectX::XMVectorSet( _Native.RightSlope, _Native.BottomSlope, 1.0f, 0.0f );
        ...
        bool CFrustum::Intersects( const CBoundingSphere& Sphere ) const
        {
            ...
            for( size_t i = 0; i < 6; ++i )
            {
                ...
                InsideAll = DirectX::XMVectorAndInt(
                    InsideAll, DirectX::XMVectorLessOrEqual( Dist[ i ], DirectX::XMVectorNegate( vRadius ) ) );

                // Check if the center is inside the plane.
                CenterInsideAll =
                    DirectX::XMVectorAndInt( CenterInsideAll, DirectX::XMVectorLessOrEqual( Dist[ i ], Zero ) );
            }
            ...
            for( size_t i = 0; i < 6; ++i )
            {
                ...
                DirectX::XMVECTOR Point =
                    DirectX::XMVectorNegativeMultiplySubtract( aPlanes[ i ]._Native, Dist[ i ], vCenter );
                ...
                for( size_t j = 0; j < 4; j++ )
                {
                    ...
                    InsideFace = DirectX::XMVectorAndInt(
                        InsideFace,
                        DirectX::XMVectorLessOrEqual( DirectX::XMVector4Dot( Point, aPlanes[ plane_index ]._Native ),
                                                      Zero ) );
                }
                ...
                Intersects = DirectX::XMVectorOrInt(
                    Intersects, DirectX::XMVectorAndInt( DirectX::XMVectorGreater( Dist[ i ], Zero ), InsideFace ) );
            }
        ...
        void CFrustum::CalcMatrix( CMatrix4x4* pOut ) const
        {
            ...
            DirectX::XMStoreFloat4x4( &pOut->_Native, m );
        }
