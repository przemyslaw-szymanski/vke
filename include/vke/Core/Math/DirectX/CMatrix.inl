    ...
    namespace Math
    {
        void CMatrix4x4::SetLookAt( const CVector3& Position, const CVector3& AtPosition, const CVector3& Up )
        {
            ...
            DirectX::XMStoreFloat4x4( &_Native,
                                      DirectX::XMMatrixLookAtRH( DirectX::XMLoadFloat3( &Position._Native ),
                                                                 DirectX::XMLoadFloat3( &AtPosition._Native ),
                                                                 DirectX::XMLoadFloat3( &Up._Native ) ) );
#else
            DirectX::XMStoreFloat4x4( &_Native,
                                      DirectX::XMMatrixLookAtLH( DirectX::XMLoadFloat3( &Position._Native ),
                                                                 DirectX::XMLoadFloat3( &AtPosition._Native ),
                                                                 DirectX::XMLoadFloat3( &Up._Native ) ) );
#endif
        }
        ...
        void CMatrix4x4::SetLookTo( const CVector3& Position, const CVector3& Direction, const CVector3& Up )
        {
            ...
            DirectX::XMStoreFloat4x4(
                &_Native,
                DirectX::XMMatrixLookToRH( VKE_XMVEC3( Position ), VKE_XMVEC3( Direction ), VKE_XMVEC3( Up ) ) );
#else
            DirectX::XMStoreFloat4x4(
                &_Native,
                DirectX::XMMatrixLookToLH( VKE_XMVEC3( Position ), VKE_XMVEC3( Direction ), VKE_XMVEC3( Up ) ) );
#endif
        }
        ...
        {
#if VKE_USE_RIGHT_HANDED_COORDINATES
            VKE_XMSTORE44( _Native,
                           DirectX::XMMatrixPerspectiveRH( Viewport.width, Viewport.height, Planes.min, Planes.max ) );
#else
            VKE_XMSTORE44( _Native,
                           DirectX::XMMatrixPerspectiveLH( Viewport.width, Viewport.height, Planes.min, Planes.max ) );
#endif
        }
...
#if VKE_USE_RIGHT_HANDED_COORDINATES
            VKE_XMSTORE44( _Native,
                           DirectX::XMMatrixPerspectiveFovRH( fovAngleY, aspectRatio, Planes.min, Planes.max ) );
#else
            VKE_XMSTORE44( _Native,
                           DirectX::XMMatrixPerspectiveFovLH( fovAngleY, aspectRatio, Planes.min, Planes.max ) );
#endif
        }
        ...
        void CMatrix4x4::Mul( const CMatrix4x4& Left, const CMatrix4x4& Right, CMatrix4x4* pOut )
        {
            ...
            DirectX::XMStoreFloat4x4( &pOut->_Native,
                                      DirectX::XMMatrixMultiply( DirectX::XMLoadFloat4x4( &Left._Native ),
        ...
        {
            DirectX::XMStoreFloat4x4( &pOut->_Native,
                                      DirectX::XMMatrixAffineTransformation( VKE_XMVEC4( vecScale ),
        ...
        void CMatrix4x4::Transform( const CVector4& vecDirection, const CMatrix4x4& mtxTransform, CVector4* pOut )
        {
