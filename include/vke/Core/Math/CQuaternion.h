...
namespace VKE
{
    namespace Math
    {
        ...
        public:
            ...
            {
                this->_Native = Right._Native;
                return *this;
            }

            CQuaternion& operator=( CQuaternion&& Right )
            {
                this->_Native = Right._Native;
                return *this;
            }
            ...
            void vke_force_inline Rotate( const CVector3& vecAxis, const float angleRadians )
            {
                Rotate( vecAxis, angleRadians, this );
            }

            void vke_force_inline Rotate( const CVector4& vecAxis, const float angleRadians )
            {
                Rotate( vecAxis, angleRadians, this );
            }
            ...
            static void vke_force_inline Rotate( const CVector3& vecAxis, const float angleRadians, CQuaternion* pOut )
            {
                Rotate( Math::CVector4( vecAxis ), angleRadians, pOut );
            }

            static void vke_force_inline Rotate( const CVector4& vecAxis, const float angleRadians, CQuaternion* pOut );
            static void vke_force_inline Rotate( const float pitch, const float yaw, const float roll,
                                                 CQuaternion* pOut );

            static const CQuaternion UNIT;

            static const vke_force_inline CQuaternion& _Unit()
            {
                return UNIT;
            }
        };
