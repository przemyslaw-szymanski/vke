...
namespace VKE
{
    namespace Math
    {
        ...
        public:
            ...
            INTERSECT_RESULT vke_force_inline Contains( const CVector3& Vec1, const CVector3& Vec2,
                                                        const CVector3& Vec3 ) const;
            ...
            static const vke_force_inline CAABB& _One()
            {
                return ONE;
            }

            static const vke_force_inline CAABB& _Zero()
            {
                return ZERO;
            }
