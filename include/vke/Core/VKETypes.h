...
#define _VKE_DECL_CMP_OPERATOR_V( _valueType, _thisMember, _op )                                                       \
    bool operator _op( const _valueType& v ) const                                                                     \
    {                                                                                                                  \
        return _thisMember _op v;                                                                                      \
    }

#define _VKE_DECL_CMP_OPERATOR( _otherType, _thisMember, _otherMember, _op )                                           \
    bool operator _op( const _otherType& Other ) const                                                                 \
    {                                                                                                                  \
        return _thisMember _op Other._otherMember;                                                                     \
    }
...
#define _VKE_DECL_CMP_OPERATORS_V( _otherValueType, _thisMember )                                                      \
    ...
    struct _STagHandle final
    {
        ...
        void operator=( const _STagHandle< InvalidTag >& )
        {
        ...
        friend std::ostream& operator<<( std::ostream& o, const _STagHandle& Handle )
        {
            o << Handle.handle;
            return o;
        }
...
#if VKE_WINDOWS
#define vke_sprintf( _pBuff, _buffSize, _pFormat, ... )                                                                \
    sprintf_s( ( _pBuff ), ( _buffSize ), ( _pFormat ), __VA_ARGS__ )
#define vke_wsprintf( _pBuff, _buffSize, _pFormat, ... )                                                               \
    swprintf_s( ( _pBuff ), ( _buffSize ), ( _pFormat ), __VA_ARGS__ )
...
#define vke_mbstowcs( _errOut, _pDst, _pDstSizeInWors, _pSrc, _pSrcSizeInBytes )                                       \
    mbstowcs_s( &( _errOut ), ( _pDst ), ( _pDstSizeInWors ), ( _pSrc ), ( _pSrcSizeInBytes ) )
#define vke_wcstombs( _errOut, _pDst, _pDstSizeInWors, _pSrc, _pSrcSizeInBytes )                                       \
    wcstombs_s( &( _errOut ), ( _pDst ), ( _pDstSizeInWors ), ( _pSrc ), ( _pSrcSizeInBytes ) )
#else
