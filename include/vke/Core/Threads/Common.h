...
namespace VKE
{
    ...
    namespace Threads
    {
        ...
        {
        public:
            TCTryLock( SyncObjType& Obj ) : m_Obj( Obj )
            {
        ...
        {
        public:
            TCScopedLock( SyncObjType& Obj ) : m_Obj( Obj )
            {
                m_Obj.lock();
            }
        ...
        template<>
        class TCScopedLock< Platform::Thread::CSpinlock > final
        {
        public:
            TCScopedLock( Platform::Thread::CSpinlock& Obj ) : m_Obj( Obj )
            {
                m_Obj.Lock();
            }
        ...
        struct VKE_API STaskParams
        {
            ...
            template< typename _T_ >
            STaskParams( const TSTaskParam< _T_ >& In, STaskResult* pRes ) : STaskParams( In.pData, In.dataSize, pRes )
            {
            }
        ...
        struct TSTaskInOut
        {
            TSTaskInOut( void* pIn, STaskResult* pOut ) :
                pInput( reinterpret_cast< _IN_* >( pIn ) ), pOutput( static_cast< TSTaskResult< _OUT_ >* >( pOut ) )
            {
            }
