...
namespace VKE
{
    namespace Utils
    {
        ...
        public:
            ...
            TCFreeListIterator( const TCFreeListIterator& Other ) : TCFreeListIterator( Other.m_pCurr, Other.m_pData )
            {
            }
        ...
        class TCFreeList : protected TCList< T, DEFAULT_ELEMENT_COUNT, AllocatorType, Policy >
        {
        protected:
            using ElementType = TSListElement< T >;
