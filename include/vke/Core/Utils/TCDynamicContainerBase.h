...
#define TC_DYNAMIC_CONTAINER_TEMPLATE template< typename DataType, class AllocatorType, class Policy, class Utils >

#define TC_DYNAMIC_CONTAINER_TEMPLATE_PARAMS DataType, AllocatorType, Policy, Utils
        ...
        template< typename T, class AllocatorType = Memory::CHeapAllocator,
                  class Policy = DynamicContainerDefaultPolicy, class Utils = DynamicContainerDefaultUtils >
        ...
        public:
            ...
            explicit TCDynamicContainer( uint32_t count ) : TCDynamicContainer()
            {
                auto res = this->Resize( count );
                assert( res );
            }

            TCDynamicContainer( uint32_t count, const DataTypeRef DefaultValue ) : TCDynamicContainer()
            {
            ...
            {
                return this->_At( this->m_pCurrPtr, index );
            }
            ...
            bool Append( const TCDynamicContainer& Other )
            {
            ...
            TCDynamicContainer& operator=( const TCDynamicContainer& Other )
            {
                Other.Copy( this );
                return *this;
            }

            TCDynamicContainer& operator=( TCDynamicContainer&& Other )
            {
                Other.Move( this );
                return *this;
            }
        ...
        TCDynamicContainer< TC_DYNAMIC_CONTAINER_TEMPLATE_PARAMS >::TCDynamicContainer(
            const TCDynamicContainer& Other ) : TCDynamicContainer()
        {
        ...
        bool TCDynamicContainer< TC_DYNAMIC_CONTAINER_TEMPLATE_PARAMS >::Append( CountType begin, CountType end,
                                                                                 const TCDynamicContainer& Other )
        {
            return Append( begin, end, Other.m_pCurrPtr );
        }

        TC_DYNAMIC_CONTAINER_TEMPLATE
        bool TCDynamicContainer< TC_DYNAMIC_CONTAINER_TEMPLATE_PARAMS >::Append( CountType       count,
