...
#define TC_LIST_TEMPLATE typename T, uint32_t DEFAULT_ELEMENT_COUNT, class AllocatorType, class Policy

#define TC_LIST_TEMPLATE_PARAMS T, DEFAULT_ELEMENT_COUNT, AllocatorType, Policy
