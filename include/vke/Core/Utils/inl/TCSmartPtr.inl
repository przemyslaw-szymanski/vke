...
template< typename T >
TCUniquePtr< T >::TCUniquePtr( TCUniquePtr& o ) : TCWeakPtr< T >( o.Release() )
{
}
...
template< typename T >
TCUniquePtr< T >::TCUniquePtr( T* pPtr ) : TCWeakPtr< T >( pPtr )
{
    pPtr = nullptr;
}
...
template< typename T, typename Policy >
TCObjectSmartPtr< T, Policy >::TCObjectSmartPtr( const TCObjectSmartPtr& o ) : TCObjectSmartPtr( o.m_pPtr )
{
}

template< typename T, typename Policy >
TCObjectSmartPtr< T, Policy >::TCObjectSmartPtr( TCObjectSmartPtr&& o ) : TCWeakPtr< T >( o.Release() )
{
}
