...
#define TC_DYNAMIC_RING_ARRAY_TEMPLATE                                                                                 \
    typename T, uint32_t DEFAULT_ELEMENT_COUNT, typename AllocatorType, typename Policy

#define TC_DYNAMIC_RING_ARRAY_TEMPLATE_PARAMS T, DEFAULT_ELEMENT_COUNT, AllocatorType, Policy

        template< typename T, uint32_t DEFAULT_ELEMENT_COUNT = 32, typename AllocatorType = Memory::CHeapAllocator,
