...
namespace VKE
{
    namespace Utils
    {
        ...
        public:
            ...
            T operator+( const TCBitset& r )
            {
                return Or( r.m_bits );
            }

            TCBitset& operator+=( const TCBitset& r )
            {
                return Add( r.m_bits );
            }
            ...
            TCBitset& operator-=( const TCBitset& r )
            {
                return Remove( r.m_bits );
            }

            bool operator==( const TCBitset& r ) const
            {
                return Contains( r.m_bits );
            }
            ...
            void operator=( const TCBitset& r )
            {
                Set( r.m_bits );
            }
            ...
            {
                return Platform::CountBits( m_bits );
            }
