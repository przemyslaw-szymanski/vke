...
#define TC_FIFO_QUEUE_TEMPLATE typename DataType, uint32_t DEFAULT_ELEMENT_COUNT, class AllocatorType, class Policy

#define TC_FIFO_QUEUE_TEMPLATE_PARAMS DataType, DEFAULT_ELEMENT_COUNT, AllocatorType, Policy
        ...
        public:
            ...
            TCFifo( CountType elemCount, const DataType Default ) : Base( elemCount, Default )
            {
            }
