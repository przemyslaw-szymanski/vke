...
namespace VKE
{
    namespace Scene
    {
        ...
        protected:
            ...
            NodeHandle _CreateNode( SOctreeNode* pCurrent, const Math::CAABB& CurrentAABB, const SNodeData& Data,
                                    uint8_t* pCurrLevel );
            ...
            UObjectHandle _UpdateObject( const handle_t& hGraph, const Scene::UObjectHandle& hObj,
                                         const Math::CAABB& AABB );

            UObjectHandle _AddObject( const NodeHandle& Node, const Math::CAABB& AABB,
