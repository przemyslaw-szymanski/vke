...
namespace VKE
{
    ...
    namespace Scene
    {
        ...
        public:
            CTerrain( CScene* pScene ) : m_pScene( pScene )
            {
            }
        ...
        protected:
            ...
            Result _LoadTileTexture( RenderSystem::CDeviceContext* pCtx, const STerrainUpdateBindingData&,
                                     cstr_t pFileName, cstr_t pResourceName, TextureHandleArray* pvTextures,
                                     TextureViewArray* pvTexViews, TexturePtrArray* pvPendingTextures );
